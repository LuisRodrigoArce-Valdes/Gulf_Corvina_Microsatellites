...
# Mu [Una sd de 1.3 es muy grande para una media de 0.0005, PERO msvar no acpeta lognormal negativa, i. e., menor a 1]
mu <- 0.0005
mu.sd <- 10
...
file.copy("../01_Curvina_Nulls10-MSVAR.txt", paste0("../0",i,"_",escenarios[i,1],"/infile"))
