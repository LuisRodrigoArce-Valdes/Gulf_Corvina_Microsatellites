...
# Reading input files
ks <- list()
ks$k2 <- read.table("../02_Nulls10/Corvina/Results/Corvina_run_10_q", header = F, sep = "")
ks$k3 <- read.table("../02_Nulls10/Corvina/Results/Corvina_run_15_q", header = F, sep = "")
ks$k4 <- read.table("../02_Nulls10/Corvina/Results/Corvina_run_20_q", header = F, sep = "")
ks$k5 <- read.table("../02_Nulls10/Corvina/Results/Corvina_run_25_q", header = F, sep = "")
